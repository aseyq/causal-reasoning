...
gen_means_explo <- df_wheel_expe2  %>% 
...
df_expe2_explo_models <- df_expe2_explo%>%
  filter(Generation == 1)%>%
...
ggsave("figures/exploration_experiment2.png", width = 5, height = 4, dpi = 300)
